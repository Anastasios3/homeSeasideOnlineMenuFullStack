...
import {
  ...
  Upload, Image as ImageIcon, Clock, RotateCcw,
    ...
    <div>
      ...
      <div className="admin-header">
        ...
        <div className="admin-header__actions">
          ...
          <button className="btn btn--secondary" onClick={() => setShowContent(true)}>
      ...
      {showContent && <ContentManager onClose={() => setShowContent(false)} />}
